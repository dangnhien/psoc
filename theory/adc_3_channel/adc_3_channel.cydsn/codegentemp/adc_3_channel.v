// ======================================================================
// adc_3_channel.v generated from TopDesign.cysch
// 08/29/2022 at 18:16
...
module top ;
	...
	wire [0:0] tmpOE__pin_input1_net;
	wire [0:0] tmpFB_0__pin_input1_net;
	wire [0:0] tmpIO_0__pin_input1_net;
	wire [0:0] tmpINTERRUPT_0__pin_input1_net;
	electrical [0:0] tmpSIOVREF__pin_input1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		pin_input1
		 (.oe(tmpOE__pin_input1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pin_input1_net[0:0]}),
		  .analog({Net_57}),
		  .io({tmpIO_0__pin_input1_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_input1_net),
		  .interrupt({tmpINTERRUPT_0__pin_input1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_input1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_input4_net;
	wire [0:0] tmpFB_0__pin_input4_net;
	wire [0:0] tmpIO_0__pin_input4_net;
	wire [0:0] tmpINTERRUPT_0__pin_input4_net;
	electrical [0:0] tmpSIOVREF__pin_input4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("804ae1c5-2ef8-47cf-bca2-45372806e696"),
		  ...
		  .input_buffer_sel(2'b00))
		pin_input4
		 (.oe(tmpOE__pin_input4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pin_input4_net[0:0]}),
		  .analog({Net_60}),
		  .io({tmpIO_0__pin_input4_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_input4_net),
		  .interrupt({tmpINTERRUPT_0__pin_input4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_input4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_input3_net;
	wire [0:0] tmpFB_0__pin_input3_net;
	wire [0:0] tmpIO_0__pin_input3_net;
	wire [0:0] tmpINTERRUPT_0__pin_input3_net;
	electrical [0:0] tmpSIOVREF__pin_input3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8c659fdd-5fdc-4c1c-9c0f-d95a611c70b6"),
		  ...
		  .input_buffer_sel(2'b00))
		pin_input3
		 (.oe(tmpOE__pin_input3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pin_input3_net[0:0]}),
		  .analog({Net_59}),
		  .io({tmpIO_0__pin_input3_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_input3_net),
		  .interrupt({tmpINTERRUPT_0__pin_input3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_input3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin_input2_net;
	wire [0:0] tmpFB_0__pin_input2_net;
	wire [0:0] tmpIO_0__pin_input2_net;
	wire [0:0] tmpINTERRUPT_0__pin_input2_net;
	electrical [0:0] tmpSIOVREF__pin_input2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e91b25a0-2f72-4eee-959e-89d589a9f66e"),
		  ...
		  .input_buffer_sel(2'b00))
		pin_input2
		 (.oe(tmpOE__pin_input2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pin_input2_net[0:0]}),
		  .analog({Net_58}),
		  .io({tmpIO_0__pin_input2_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_input2_net),
		  .interrupt({tmpINTERRUPT_0__pin_input2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_input2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

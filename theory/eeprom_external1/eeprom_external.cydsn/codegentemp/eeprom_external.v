// ======================================================================
// eeprom_external.v generated from TopDesign.cysch
// 08/30/2022 at 15:15
...
module top ;
	...
	wire [0:0] tmpOE__LedYellow_0_net;
	wire [0:0] tmpFB_0__LedYellow_0_net;
	wire [0:0] tmpIO_0__LedYellow_0_net;
	wire [0:0] tmpINTERRUPT_0__LedYellow_0_net;
	electrical [0:0] tmpSIOVREF__LedYellow_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LedYellow_0
		 (.oe(tmpOE__LedYellow_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedYellow_0_net[0:0]}),
		  .io({tmpIO_0__LedYellow_0_net[0:0]}),
		  .siovref(tmpSIOVREF__LedYellow_0_net),
		  .interrupt({tmpINTERRUPT_0__LedYellow_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedYellow_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedYellow_1_net;
	wire [0:0] tmpFB_0__LedYellow_1_net;
	wire [0:0] tmpIO_0__LedYellow_1_net;
	wire [0:0] tmpINTERRUPT_0__LedYellow_1_net;
	electrical [0:0] tmpSIOVREF__LedYellow_1_net;

	cy_psoc3_pins_v1_10
		#(.id("e4f57a98-7dfa-493c-9a24-ebdc5366fe99"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LedYellow_1
		 (.oe(tmpOE__LedYellow_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedYellow_1_net[0:0]}),
		  .io({tmpIO_0__LedYellow_1_net[0:0]}),
		  .siovref(tmpSIOVREF__LedYellow_1_net),
		  .interrupt({tmpINTERRUPT_0__LedYellow_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedYellow_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedYellow_2_net;
	wire [0:0] tmpFB_0__LedYellow_2_net;
	wire [0:0] tmpIO_0__LedYellow_2_net;
	wire [0:0] tmpINTERRUPT_0__LedYellow_2_net;
	electrical [0:0] tmpSIOVREF__LedYellow_2_net;

	cy_psoc3_pins_v1_10
		#(.id("d516ca72-cbf4-4de3-9f34-e703f6becc05"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LedYellow_2
		 (.oe(tmpOE__LedYellow_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedYellow_2_net[0:0]}),
		  .io({tmpIO_0__LedYellow_2_net[0:0]}),
		  .siovref(tmpSIOVREF__LedYellow_2_net),
		  .interrupt({tmpINTERRUPT_0__LedYellow_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedYellow_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedYellow_3_net;
	wire [0:0] tmpFB_0__LedYellow_3_net;
	wire [0:0] tmpIO_0__LedYellow_3_net;
	wire [0:0] tmpINTERRUPT_0__LedYellow_3_net;
	electrical [0:0] tmpSIOVREF__LedYellow_3_net;

	cy_psoc3_pins_v1_10
		#(.id("bf8a1635-a359-48e1-ae78-79433cf862ae"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LedYellow_3
		 (.oe(tmpOE__LedYellow_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedYellow_3_net[0:0]}),
		  .io({tmpIO_0__LedYellow_3_net[0:0]}),
		  .siovref(tmpSIOVREF__LedYellow_3_net),
		  .interrupt({tmpINTERRUPT_0__LedYellow_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedYellow_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedYellow_4_net;
	wire [0:0] tmpFB_0__LedYellow_4_net;
	wire [0:0] tmpIO_0__LedYellow_4_net;
	wire [0:0] tmpINTERRUPT_0__LedYellow_4_net;
	electrical [0:0] tmpSIOVREF__LedYellow_4_net;

	cy_psoc3_pins_v1_10
		#(.id("5984b78e-51e3-4ed5-83c7-f189d8e56787"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LedYellow_4
		 (.oe(tmpOE__LedYellow_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedYellow_4_net[0:0]}),
		  .io({tmpIO_0__LedYellow_4_net[0:0]}),
		  .siovref(tmpSIOVREF__LedYellow_4_net),
		  .interrupt({tmpINTERRUPT_0__LedYellow_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedYellow_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedYellow_5_net;
	wire [0:0] tmpFB_0__LedYellow_5_net;
	wire [0:0] tmpIO_0__LedYellow_5_net;
	wire [0:0] tmpINTERRUPT_0__LedYellow_5_net;
	electrical [0:0] tmpSIOVREF__LedYellow_5_net;

	cy_psoc3_pins_v1_10
		#(.id("253077e1-9cfc-4a6f-a896-30ab006a960e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LedYellow_5
		 (.oe(tmpOE__LedYellow_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedYellow_5_net[0:0]}),
		  .io({tmpIO_0__LedYellow_5_net[0:0]}),
		  .siovref(tmpSIOVREF__LedYellow_5_net),
		  .interrupt({tmpINTERRUPT_0__LedYellow_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedYellow_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedYellow_6_net;
	wire [0:0] tmpFB_0__LedYellow_6_net;
	wire [0:0] tmpIO_0__LedYellow_6_net;
	wire [0:0] tmpINTERRUPT_0__LedYellow_6_net;
	electrical [0:0] tmpSIOVREF__LedYellow_6_net;

	cy_psoc3_pins_v1_10
		#(.id("c9b89f5e-ea0e-4f7a-904a-0838e6b79655"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LedYellow_6
		 (.oe(tmpOE__LedYellow_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedYellow_6_net[0:0]}),
		  .io({tmpIO_0__LedYellow_6_net[0:0]}),
		  .siovref(tmpSIOVREF__LedYellow_6_net),
		  .interrupt({tmpINTERRUPT_0__LedYellow_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedYellow_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedYellow_7_net;
	wire [0:0] tmpFB_0__LedYellow_7_net;
	wire [0:0] tmpIO_0__LedYellow_7_net;
	wire [0:0] tmpINTERRUPT_0__LedYellow_7_net;
	electrical [0:0] tmpSIOVREF__LedYellow_7_net;

	cy_psoc3_pins_v1_10
		#(.id("9d1931cb-7a2b-40a7-9236-b332d99032b4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LedYellow_7
		 (.oe(tmpOE__LedYellow_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedYellow_7_net[0:0]}),
		  .io({tmpIO_0__LedYellow_7_net[0:0]}),
		  .siovref(tmpSIOVREF__LedYellow_7_net),
		  .interrupt({tmpINTERRUPT_0__LedYellow_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedYellow_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

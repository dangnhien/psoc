// ======================================================================
// basic_counter.v generated from TopDesign.cysch
// 08/20/2022 at 14:13
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a79b5ee8-867e-4265-afb4-0166f309e6ff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Voltage_5V (
        .connect({
            Net_12
        })
    );
    defparam Voltage_5V.comp_name = "Power_v1_0";
    defparam Voltage_5V.port_names = "T1";
    defparam Voltage_5V.width = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("31120c23-5d5d-4c18-a489-5883c5ff29ec"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("45b3ad0e-a26a-488e-8274-41a3e1b0a884"),
		  .source_clock_id(""),
		  .divisor(0),

...
#include "lcd_LCDPort.h"
    ...
    #define lcd_LCDPort_SetP4PinDriveMode(shift, mode)  \
    do { \
        lcd_LCDPort_PC =   (lcd_LCDPort_PC & \
                                (uint32)(~(uint32)(lcd_LCDPort_DRIVE_MODE_IND_MASK << \
                                (lcd_LCDPort_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << \
                                (lcd_LCDPort_DRIVE_MODE_BITS * (shift))); \
    } while (0)
#else
        ...
        #define lcd_LCDPort_SetP4PinDriveMode(shift, mode)  \
        do { \
            lcd_LCDPort_USBIO_CTRL_REG = (lcd_LCDPort_USBIO_CTRL_REG & \
                                    (uint32)(~(uint32)(lcd_LCDPort_DRIVE_MODE_IND_MASK << \
                                    (lcd_LCDPort_DRIVE_MODE_BITS * (shift))))) | \
                                    (uint32)((uint32)(mode) << \
                                    (lcd_LCDPort_DRIVE_MODE_BITS * (shift))); \
    ...
    *******************************************************************************/
    ...
    {
		lcd_LCDPort_SetP4PinDriveMode(lcd_LCDPort__0__SHIFT, mode);
		lcd_LCDPort_SetP4PinDriveMode(lcd_LCDPort__1__SHIFT, mode);
		lcd_LCDPort_SetP4PinDriveMode(lcd_LCDPort__2__SHIFT, mode);
		lcd_LCDPort_SetP4PinDriveMode(lcd_LCDPort__3__SHIFT, mode);
		lcd_LCDPort_SetP4PinDriveMode(lcd_LCDPort__4__SHIFT, mode);
		lcd_LCDPort_SetP4PinDriveMode(lcd_LCDPort__5__SHIFT, mode);
		lcd_LCDPort_SetP4PinDriveMode(lcd_LCDPort__6__SHIFT, mode);
    }
#endif
...
void lcd_LCDPort_SetInterruptMode(uint16 position, uint16 mode)
{
    ...
    intrCfg =  lcd_LCDPort_INTCFG & (uint32)(~(uint32)position);
    lcd_LCDPort_INTCFG = intrCfg | ((uint32)position & (uint32)mode);
}

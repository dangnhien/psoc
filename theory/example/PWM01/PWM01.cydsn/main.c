...
*
* Description: 
*  This code example demonstrates how to use the PSoC 4 fixed function PWM to 
*  generate signal with a variable duty cycle.
*
* Related Document: 
*  CE195351_PSoC4_Fixed_Function_PWM.pdf
*
* Hardware Dependency: 
*  See CE195351_PSoC4_Fixed_Function_PWM.pdf
*
*******************************************************************************

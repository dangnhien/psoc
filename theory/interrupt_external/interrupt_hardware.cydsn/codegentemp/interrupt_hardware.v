...
module top ;
    ...
    cy_annotation_universal_v1_0 ground (
        .connect({
            Net_8
        })
    );
    defparam ground.comp_name = "Gnd_v1_0";
    defparam ground.port_names = "T1";
    defparam ground.width = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("770f2b46-bae6-4816-9dd0-34cc0488973c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),

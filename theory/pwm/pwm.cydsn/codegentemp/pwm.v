...
module top ;
	...
	cy_clock_v1_0
		#(.id("787f80de-15a8-41f6-8774-03705681b020"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__pwmToServer_net;
	wire [0:0] tmpFB_0__pwmToServer_net;
	wire [0:0] tmpIO_0__pwmToServer_net;
	wire [0:0] tmpINTERRUPT_0__pwmToServer_net;
	electrical [0:0] tmpSIOVREF__pwmToServer_net;
	...
	cy_psoc3_pins_v1_10
		...
		pwmToServer
		 (.oe(tmpOE__pwmToServer_net),
		  .y({Net_6}),
		  .fb({tmpFB_0__pwmToServer_net[0:0]}),
		  .io({tmpIO_0__pwmToServer_net[0:0]}),
		  .siovref(tmpSIOVREF__pwmToServer_net),
		  .interrupt({tmpINTERRUPT_0__pwmToServer_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pwmToServer_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

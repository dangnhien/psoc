// ======================================================================
// counter.v generated from TopDesign.cysch
// 08/23/2022 at 03:50
...
module top ;
	...
	wire [0:0] tmpOE__ledRedd_net;
	wire [0:0] tmpFB_0__ledRedd_net;
	wire [0:0] tmpIO_0__ledRedd_net;
	wire [0:0] tmpINTERRUPT_0__ledRedd_net;
	electrical [0:0] tmpSIOVREF__ledRedd_net;
	...
	cy_psoc3_pins_v1_10
		...
		ledRedd
		 (.oe(tmpOE__ledRedd_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ledRedd_net[0:0]}),
		  .io({tmpIO_0__ledRedd_net[0:0]}),
		  .siovref(tmpSIOVREF__ledRedd_net),
		  .interrupt({tmpINTERRUPT_0__ledRedd_net[0:0]}),
		  .annotation({Net_18}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__ledRedd_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__button_single_net;
	wire [0:0] tmpIO_0__button_single_net;
	wire [0:0] tmpINTERRUPT_0__button_single_net;
	electrical [0:0] tmpSIOVREF__button_single_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		button_single
		 (.oe(tmpOE__button_single_net),
		  .y({1'b0}),
		  .fb({Net_6}),
		  .io({tmpIO_0__button_single_net[0:0]}),
		  .siovref(tmpSIOVREF__button_single_net),
		  .interrupt({tmpINTERRUPT_0__button_single_net[0:0]}),
		  .annotation({Net_23}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__button_single_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
